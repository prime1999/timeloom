		...
		<main className="px-6 md:px-10 mb-6">
			...
			<header className="max-w-3xl mx-auto flex flex-col gap-8 justify-center text-center lg:mt-20 mt-16 relative">
				...
				<h1 className="scroll-m-20 text-4xl font-semibold leading-tight lg:leading-tight lg:text-6xl bg-gradient-to-br from-[#000000ab] from-[30%] to-[#3d3d3df0] dark:bg-gradient-to-br dark:from-[#ffffffff] dark:from-[30%] dark:to-[#ffffff80] text-transparent bg-clip-text">
					Craft your tech journey timeline on <span className="">Timeloom</span>
				</h1>
				<p className="text-muted-foreground">
					Timeloom helps you to document your technical journey in an activity
					timeline like page. You can create your own page, craft it as you like
